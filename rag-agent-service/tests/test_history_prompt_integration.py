...
from app.agent.decision_engine import GatewayDecisionEngine
from app.agent.models import AgentAction
from app.runtime.planner import GatewaySemanticAnalyzer
...
def test_history_enters_agent_decision_prompt() -> None:
    gateway = CapturingGateway(
        {"action": "ANSWER", "final_answer": "Retention is required."}
    )
