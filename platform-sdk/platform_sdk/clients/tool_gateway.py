...
def _execution_headers(context: ToolContext) -> dict[str, str]:
    ...
    values = {
        ...
        "X-Release-Stage": context.release_stage,
        "X-Release-Projection-Revision": str(context.release_projection_revision),
        "X-Traffic-Policy-Version": context.traffic_policy_version,
        "X-Side-Effect-Policy-Version": context.side_effect_policy_version,
