...
def _context(
    ...
    x_root_task_id: str = Header(default="", alias="X-Root-Task-Id"),
    x_business_operation_id: str = Header(default="", alias="X-Business-Operation-Id"),
    x_operation_id: str = Header(default="", alias="X-Operation-Id"),
    x_step_id: str = Header(default="", alias="X-Step-Id"),
    x_plan_id: str = Header(default="", alias="X-Plan-Id"),
    x_plan_admission_id: str = Header(default="", alias="X-Plan-Admission-Id"),
    ...
    return InvocationContext(
        ...
        root_task_id=x_root_task_id,
        business_operation_id=x_business_operation_id,
        operation_id=x_operation_id,
        step_id=x_step_id,
        plan_id=x_plan_id,
        plan_admission_id=x_plan_admission_id,
        trace_id=x_trace_id,
        run_id=x_run_id,
